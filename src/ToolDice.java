...
public class ToolDice extends JPanel {
	private Tool[] tools;
	private int toolDiceWidth = 168;
	private int toolDiceHeight = 224;
	...
	public ToolDice() {
		...
		tools[0] = new Rock();
		tools[0].setBounds(56, 0, 54, 54);
		add(tools[0]);

		tools[1] = new Scissors();
		tools[1].setBounds(56, 56, 54, 54);
		tools[1].setBackground(Color.red);
		tools[1].setOpaque(true);
		add(tools[1]);

		tools[2] = new Paper();
		tools[2].setBounds(56, 112, 54, 54);
		add(tools[2]);

		tools[3] = new Rock();
		tools[3].setBounds(56, 168, 54, 54);
		add(tools[3]);
	...
	public void setToolDiceWidth(int toolDiceWidth) {
		this.toolDiceWidth = toolDiceWidth;
	}
	...
	public void setToolDiceHeight(int toolDiceHeight) {
		this.toolDiceHeight = toolDiceHeight;
	}
